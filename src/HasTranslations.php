...
trait HasTranslations
{
    ...
    public function getCasts() : array
    {
        return array_merge(
            parent::getCasts(),
            array_fill_keys($this->getTranslatableAttributes(), 'translate')
        );
    }
    ...
    protected function castAttribute($key, $value)
    {
        ...
        switch ($this->getCastType($key)) {
			...
			case 'translate':
				return (array_key_exists(app()->getLocale(), $this->fromJson($value))) ? $this->fromJson($value)[app()->getLocale()] : '';
            default:
                return $value;
        }
	}
    ...
    public function setAttribute($key, $value)
    {
		...
		if ($this->isTranslatableAttribute($key)) {
			if (is_array($value)) {
            	...
            	return $this->fillJsonAttribute($key.'->'.app()->getLocale(), $value);
			}
		}
